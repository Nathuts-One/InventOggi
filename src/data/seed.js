export const initialData = {
  categories: [
    ...
    { id: 3, name: 'Giratto', active: true },
    { id: 4, name: 'Delícia', active: true },
    { id: 5, name: 'Especial', active: true },
    { id: 6, name: 'Fazenda', active: true },
    { id: 7, name: 'Festa', active: true },
    { id: 8, name: 'Frutos', active: true },
    { id: 9, name: 'Hello Kitty', active: true },
    { id: 10, name: 'Duo', active: true },
    { id: 11, name: 'Zero', active: true },
    { id: 12, name: 'Duetto', active: true },
    { id: 13, name: 'Seleções', active: true },
    { id: 14, name: 'Tradicional', active: true },
    { id: 15, name: 'Sensa', active: true },
    { id: 16, name: 'Top Sundae', active: true },
    { id: 17, name: 'Disney', active: true },
    { id: 19, name: 'Regionais', active: true },
    { id: 18, name: 'Espaços Vazios', active: true },
  ],
  products: [
    // Açai
